...
Customer service and usage records
...
Data analysis, preprocessing, training, evaluation, and risk grouping
...
Optional presentation or final report

How to Run

Place Client.csv and Record.csv in the input folder beside main.py.
...
If the script still contains the original absolute Windows paths, replace the two CSV-loading statements with:
...
Remove the unused import of primitive_column_to_ndarray from pandas.core.interchange.from_dataframe, if present. This internal pandas helper is not needed by the project.
